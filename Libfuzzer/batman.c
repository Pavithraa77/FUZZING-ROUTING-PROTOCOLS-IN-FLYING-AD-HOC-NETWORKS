...
void fuzz_handle_ogm(const unsigned char *buf, int len)
{
    struct bat_packet local_pkt;
    ...
    /* ---------- copy input (libFuzzer-safe) ---------- */
    memcpy(&local_pkt, buf, sizeof(struct bat_packet));
    bat_packet = &local_pkt;
